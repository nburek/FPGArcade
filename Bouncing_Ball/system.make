...
# C:\FPGArcade\Bouncing_Ball\system.mhs
# The software specification of the system is in file :
# C:\FPGArcade\Bouncing_Ball\system.mss
...
Bouncing_Ball_program: $(CYG_BOUNCING_BALL_OUTPUT) 

$(CYG_BOUNCING_BALL_OUTPUT) : $(BOUNCING_BALL_SOURCES) $(BOUNCING_BALL_HEADERS) $(BOUNCING_BALL_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/bouncing_ball_compiler.opt
	@mkdir -p $(BOUNCING_BALL_OUTPUT_DIR) 
	$(BOUNCING_BALL_CC) $(BOUNCING_BALL_CC_OPT) $(BOUNCING_BALL_SOURCES) -o $(CYG_BOUNCING_BALL_OUTPUT) \
	$(BOUNCING_BALL_OTHER_CC_FLAGS) $(BOUNCING_BALL_INCLUDES) $(BOUNCING_BALL_LIBPATH) \
	$(BOUNCING_BALL_CFLAGS) $(BOUNCING_BALL_LFLAGS) 
	$(BOUNCING_BALL_CC_SIZE) $(CYG_BOUNCING_BALL_OUTPUT) 
	@echo ""

Bouncing_Ball_programclean:
	rm -f $(BOUNCING_BALL_OUTPUT) 
