...
/* Definitions for peripheral BLOCK_OUTPUT */
#define XPAR_BLOCK_OUTPUT_BASEADDR 0x81440000
#define XPAR_BLOCK_OUTPUT_HIGHADDR 0x8144FFFF
#define XPAR_BLOCK_OUTPUT_DEVICE_ID 0
#define XPAR_BLOCK_OUTPUT_INTERRUPT_PRESENT 0
#define XPAR_BLOCK_OUTPUT_IS_DUAL 1


/* Definitions for peripheral JOYSTICK_GPIO */
#define XPAR_JOYSTICK_GPIO_BASEADDR 0x81420000
#define XPAR_JOYSTICK_GPIO_HIGHADDR 0x8142FFFF
