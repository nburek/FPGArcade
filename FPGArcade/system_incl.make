...
# Project:C:\FPGArcade\FPGArcade\system.xmp
#
...
FROGGER_OUTPUT_DIR = Frogger
FROGGER_OUTPUT = $(FROGGER_OUTPUT_DIR)/executable.elf
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -s mti -X C:/FPGArcade/FPGArcade/
...
implementation/graphics_gpio_wrapper.ngc \
implementation/vga_module_0_wrapper.ngc
...
FROGGER_HEADERS = Frogger/lib/joystickLibrary.h Frogger/lib/graphicsLibrary.h Frogger/lib/frog_graphics.h Frogger/lib/collisions.h Frogger/lib/enemies.h Frogger/lib/frog.h 
...
FROGGER_INCLUDES = -I./microblaze_0/include/  -IFrogger/lib/ # -I
FROGGER_LFLAGS = # -l
...
FROGGER_LIBG_OPT = -$(FROGGER_MODE) microblaze_0
FROGGER_CC_INFERRED_FLAGS= -mxl-soft-mul -mxl-barrel-shift -mxl-pattern-compare -mcpu=v8.00.b 
FROGGER_CC_START_ADDR_FLAG=  #  # -Wl,-defsym -Wl,_TEXT_START_ADDR=
FROGGER_CC_STACK_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_STACK_SIZE=
FROGGER_CC_HEAP_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_HEAP_SIZE=
FROGGER_OTHER_CC_FLAGS= $(FROGGER_CC_GLOBPTR_FLAG)  \
