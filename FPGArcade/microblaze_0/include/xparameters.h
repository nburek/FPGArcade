...
/* Definitions for peripheral GRAPHICS_GPIO */
#define XPAR_GRAPHICS_GPIO_BASEADDR 0x81420000
#define XPAR_GRAPHICS_GPIO_HIGHADDR 0x8142FFFF
#define XPAR_GRAPHICS_GPIO_DEVICE_ID 0
#define XPAR_GRAPHICS_GPIO_INTERRUPT_PRESENT 0
#define XPAR_GRAPHICS_GPIO_IS_DUAL 1


/* Definitions for peripheral JOYSTICK_GPIO */
#define XPAR_JOYSTICK_GPIO_BASEADDR 0x81400000
#define XPAR_JOYSTICK_GPIO_HIGHADDR 0x8140FFFF
#define XPAR_JOYSTICK_GPIO_DEVICE_ID 1
#define XPAR_JOYSTICK_GPIO_INTERRUPT_PRESENT 0
#define XPAR_JOYSTICK_GPIO_IS_DUAL 1
