...
# C:\FPGArcade\FPGArcade_Burek_Griebel\Project\FPGA\Source\FPGArcade\system.mhs
# The software specification of the system is in file :
# C:\FPGArcade\FPGArcade_Burek_Griebel\Project\FPGA\Source\FPGArcade\system.mss
...
Frogger_program: $(CYG_FROGGER_OUTPUT) 

$(CYG_FROGGER_OUTPUT) : $(FROGGER_SOURCES) $(FROGGER_HEADERS) $(FROGGER_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/frogger_compiler.opt
	@mkdir -p $(FROGGER_OUTPUT_DIR) 
	$(FROGGER_CC) $(FROGGER_CC_OPT) $(FROGGER_SOURCES) -o $(CYG_FROGGER_OUTPUT) \
	$(FROGGER_OTHER_CC_FLAGS) $(FROGGER_INCLUDES) $(FROGGER_LIBPATH) \
	$(FROGGER_CFLAGS) $(FROGGER_LFLAGS) 
	$(FROGGER_CC_SIZE) $(CYG_FROGGER_OUTPUT) 
	@echo ""

Frogger_programclean:
	rm -f $(FROGGER_OUTPUT) 
